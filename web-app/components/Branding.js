			...
			<div className="align-center">
				...
				<div className="flex justify-between space-x-4">
					...
					<Menu as="div" className="relative inline-block text-left">
						<div>
							<Menu.Button className="inline-flex w-full justify-center rounded-md items-center text-lg dark:bg-black bg-opacity-20 px-4 py-2 font-medium dark:text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
								Other Projects
								<ChevronDownIcon
