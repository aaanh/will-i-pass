...
if is_homework == 1:
    num_of_hw = int(
        input("Number of homework? (positive integer)\n> Answer: "))
...
if is_midterm == 1:
    num_of_mids = int(
        input("Number of midterms? (positive integer)\n> Answer: "))
    weight_of_mids = float(
        input("Enter total weight of midterm (0.0 to 1.0): "))
...
if is_final == 1:
    num_of_fins = int(
        input("Number of finals? (positive integer)\n> Answer: "))
    weight_of_fins = float(
        input("Enter total weight of finals (0.0 to 1.0): "))
...
if total_weight < 1.0 or total_weight > 1.0:
    is_continue = int(input(
        f"Total weight input is less than or higher than 100%. Do you want to continue? 0 = no, 1 = yes\n> Answer: "))
    if is_continue == 1:
        will_i_pass(passing_grade, homeworks, midterms, labs, finals, weight_of_fins, weight_of_mids,
                    weight_of_hw, weight_of_labs) if print("Yes, you will pass") else print("No, you ain't")
    else:
